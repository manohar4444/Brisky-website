! function e(t, n, i) {
    ...
    1: [function(e, t, n) {
        ...
        if ("desktop" !== i("mode") && void 0 !== typeof window.orientation && o(window).width() < 737) throw window.location = "/mobile/", new Error("mobile");
        ...
        o(function() {
            function e(e, t) {
                ...
                return n.presentationWidth -= n.presentationHeight * u.margin, n.presentationHeight -= n.presentationHeight * u.margin, "string" == typeof n.width && /%$/.test(n.width) && (n.width = parseInt(n.width, 10) / 100 * n.presentationWidth), "string" == typeof n.height && /%$/.test(n.height) && (n.height = parseInt(n.height, 10) / 100 * n.presentationHeight), n
            }
            o("body").removeClass("before").show().f(), o.isDevice && o("html").addClass("mobile"), o(".null-slide-bottom span").click(function() {
                o.fn.fullpage.moveSectionDown()
            });
            var t = o("[data-iPhone]"),
                n = (t.find("[data-iphone-slider]"), 435),
                i = o(".js-video"),
                a = o(".iPhone .js-video__slides"),
                l = (o("#skrollr-body"), new s(o("[data-map]"), t, t.find("[data-map-phone]")));
            l.updateDimentions(), l.put(), o.isDevice ? o(".js-video").remove() : (o(".js-video-placeholder").remove(), o(window).load(function() {
                ...
                }), a = o(".iPhone .js-video__slides"), i = o(".js-video").fadeOut().each(function() {
                    o(this).get(0).pause()
                }), "" === window.location.hash && (o(".js-video__nicer-way").fadeIn().get(0).play(), o(".js-video__nicer-way").parent().prev(".iPhone-video-placeholder").fadeOut())
            }));
            var c = 1;
            ! function() {
                function e(e, t) {
                    ...
                    return n.presentationWidth -= n.presentationHeight * i.margin, n.presentationHeight -= n.presentationHeight * i.margin, "string" == typeof n.width && /%$/.test(n.width) && (n.width = parseInt(n.width, 10) / 100 * n.presentationWidth), "string" == typeof n.height && /%$/.test(n.height) && (n.height = parseInt(n.height, 10) / 100 * n.presentationHeight), n
                }

                function t(t) {
                    var n = e();
                    c = Math.min(n.presentationWidth / n.width, n.presentationHeight / n.height), c = Math.max(c, i.minScale), c = Math.min(c, i.maxScale), t.css({
                        transform: "scale(" + c + ")"
                    })
                }
            ...
            o(window).resize(function() {
                var i = e();
                phoneScale = Math.min(i.presentationWidth / i.width, i.presentationHeight / i.height), phoneScale = Math.max(phoneScale, u.minScale), phoneScale = Math.min(phoneScale, u.maxScale), o(".top-words").css({
            ...
            o(".js-map-slide").on("mousedown", function() {
                o(this).addClass("_active"), d && clearTimeout(d)
            }).mouseup(function() {
            ...
            m.each(function() {
                ...
                onLeave: function(e, t, n, r) {
                    o(".phone-map").hide(), i.each(function() {
                        var e = o(this).get(0);
                        e.pause(), e.currentTime = 0
                    }), "fact" == r ? (f.addClass("_onFact"), o(".iPhone-video-placeholder").next().fadeOut()) : (f.removeClass("_onFact"), o(".iPhone-video-placeholder").next().fadeIn()), "nicer_way" == r && (o.isDevice || (o(".js-video__nicer-way").fadeIn().get(0).play(), o(".js-video__nicer-way").parent().prev(".iPhone-video-placeholder").fadeOut())), "tours" == r && (setTimeout(function() {
                        o(".tour-nyc").airport(["NYC"])
                    }, 600), o.isDevice || (o(".js-video__tours").fadeIn().get(0).play(), o(".js-video__tours").parent().prev(".iPhone-video-placeholder").fadeOut())), "map" == r && (l.updateDimentions(), l.put(), o(".phone-map").show()), "slides" == r && (o.isDevice || (o(".swiper-slide-active .js-video__slides").fadeIn().get(0).play(), o(".swiper-slide-active .js-video__slides").eq(0).parent().prev(".iPhone-video-placeholder").fadeOut())), "about" == r && o(".about-parallax-item, .about-rows ._row img").removeClass("_moveDown"), "subscribe" == r && (o(".subscribe-parallax-item").removeClass("_moveDown"), "down" == n && o(".about-parallax-item, .about-rows ._row img").addClass("_moveDown")), "about" == r || "subscribe" == r || "share" == r ? f.addClass("_hidden") : f.removeClass("_hidden"), "fact" == v[0] ? t > 1 && y.swipeTo(t - 2) : y.swipeTo(t - 1), "share" == r ? ("down" == n && o(".subscribe-parallax-item").addClass("_moveDown"), setTimeout(function() {
            ...
            }), o(".null-slide").length && (f.addClass("_onFact"), o(".iPhone-video-placeholder").next().fadeOut()), o(".logo").click(function() {
            ...
            var y = o(".iPhone-vertical-slider .swiper-container").swiper({
                ...
                w = o(".iPhone-horizontal-slider .swiper-container").swiper({
                    ...
                    onSlideChangeEnd: function(e) {
                        o.isDevice || (a.each(function() {
                            var e = o(this).get(0);
                            e.pause(), e.currentTime = 0
                        }), o(".js-video__slides").fadeIn().get(e.activeIndex).play(), o(".js-video__slides").eq(e.activeIndex).parent().prev(".iPhone-video-placeholder").fadeOut())
                    }
                }),
                x = null,
                b = o("[data-slider-inner]").swiper({
                    ...
                    onSwiperCreated: function() {
                        x = o(".js-inner-slider").find(".slider-item"), scalingElement = o("[data-elementsize]")
                    },
                    onSlideChangeStart: function(e) {
                        ! function(e) {
                            setTimeout(function() {
            ...
            C.on("click", function() {
                o("._slide-4 .swiper-slide").removeClass("show-left-slide").removeClass("show-right-slide"), setTimeout(function() {
                    S === !0 && o(".tour-slider .swiper-slide-active").prev().addClass("show-left-slide")
                }, 300), b.swipePrev(), w.swipePrev()
            }), o.isDevice || C.on("mouseenter", function() {
                o(".tour-slider .swiper-slide-active").prev().addClass("show-left-slide"), S = !0
            }).on("mouseleave", function() {
                S = !1, o(".tour-slider .swiper-slide").removeClass("show-left-slide")
            }), k.on("click", function() {
                o(".tour-slider .swiper-slide").removeClass("show-left-slide").removeClass("show-right-slide"), setTimeout(function() {
                    T === !0 && o("[data-slider-inner-switch-right]").mouseenter()
                }, 300), b.swipeNext(), w.swipeNext()
            }), o.isDevice || k.on("mouseenter", function() {
                o(".tour-slider .swiper-slide-active").next().addClass("show-right-slide"), T = !0
            }).on("mouseleave", function() {
                T = !1, o(".tour-slider .swiper-slide").removeClass("show-right-slide")
                ...
                i && o.ajax({
                    ...
                    success: function(e) {
                        "undefined" != typeof e.msg && (t.addClass("_subscribed"), t.html(e.msg))
                    },
                    error: function(e) {
                        console.log(e)
                    }
                ...
                clearTimeout(p), p = setTimeout(function() {
                    o(window).height(), o(window).width();
                    l.updateDimentions(), l.put()
                }, 300)
            })
        })
    }, {
    ...
    2: [function(e, t, n) {
        var i = e("../vendor/jquery"),
            o = function(e, t, n) {
                this.phone = t, this.element = e, this.container = e.parent(), this.draggings = !1, this.phoneMap = n, this.phoneSlider = this.phone.find(".iPhone-slider"), this.memo = {
                    top: 0,
                    left: 0
                }, this.previousMove = {
                    pageX: 0,
                    ...
                    pageY: 0,
                    timeStamp: null
                }, void 0 !== t && t.on("mousedown", this.mouseDown.bind(this)), this.container.on("mousedown", this.mouseDown.bind(this)), i(window).on("mouseup", this.mouseUp.bind(this)), i(window).on("mousemove", this.mouseMove.bind(this)), this.element.css({
        ...
        o.prototype.mouseDown = function(e) {
            e.preventDefault(), this.phoneOffset = this.phoneSlider.offset(), this.draggings = !0, this.memo.top = this.mapPosition.top - e.pageY, this.memo.left = this.mapPosition.left - e.pageX, this.setCurrentMove(e), this.element.css({
                transitionDuration: "0ms"
            }), this.phoneMap.css({
                transitionDuration: "0ms"
            })
        }, o.prototype.mouseUp = function(e) {
            this.draggings = !1, this.element.css({
                transitionDuration: "500ms"
            }), this.phoneMap.css({
                transitionDuration: "500ms"
            }), dX = e.pageX - this.previousMove.pageX, dY = e.pageY - this.previousMove.pageY, dT = e.timeStamp - this.previousMove.timeStamp, speedX = dX / dT, speedY = dY / dT;
            var t = this.memo.top + e.pageY + 200 * speedY,
                n = this.memo.left + e.pageX + 200 * speedX;
            n = Math.min(Math.max(this.boundingBox.left, n), 0), t = Math.min(Math.max(this.boundingBox.bottom, t), 0), this.mapPosition.left = n, this.mapPosition.top = t, this.put()
        }, o.prototype.mouseMove = function(e) {
            if (this.draggings) {
                e.preventDefault(), e.stopPropagation(), Math.min(Math.max(-1440, n), 0), this.setPreviousMove(this.currentMove), this.setCurrentMove(e);
            ...
            this.phoneOffset = this.phoneSlider.offset(), this.mapPosition = {
            ...
            this.currentMove.pageX = e.pageX, this.currentMove.pageY = e.pageY, this.currentMove.timeStamp = e.timeStamp
        }, o.prototype.setPreviousMove = function(e) {
            this.previousMove.pageX = e.pageX, this.previousMove.pageY = e.pageY, this.previousMove.timeStamp = e.timeStamp
        }, t.exports = o
    }, {
        "../vendor/jquery": 8
    }],
    3: [function(e, t, n) {
        var i = (e("../vendor/jquery.js"), function(e) {
                return
            }),
            o = function(e, t) {
                t = t || "", window.open(e + t + " " + window.location, "_blank", "menubar=no,location=no,resizable=yes,scrollbars=yes,status=no,width=600,height=400")
            };
        t.exports = {
            scale: i,
            createWindow: o
    ...
    4: [function(e, t, n) {
        var i = e("./jquery.js");
        window.jQuery = i, i.isDevice = /android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(navigator.userAgent.toLowerCase()), e("./parallax.js"), e("./retina.js"), e("./swiper.js"), e("./jquery.fullPage.js"), e("./jquery.airport-1.1.source.js"), e("./f.js"), t.exports = i
    }, {
        "./f.js": 5,
        ...
        ! function(e) {
            var t = new Array,
                ...
                l = function() {
                    ...
                    jLoader = e("<div></div>").attr("id", "f").appendTo(jOverlay);
                    e(window).width() - e(jLoader).width();
                    e(jLoader).css({
                        position: "absolute"
                    }), jBar = e('<div><div class="jpreBar__icon"></div></div>').attr("id", "jpreBar").css({
                        width: "0%"
                    }).appendTo(jLoader), r.showPercentage && (jPer = e("<div></div>").attr("id", "jprePercentage").appendTo(jBar).html("Loading...")), r.autoclose || (jButton = e("<div></div>").attr("id", "jpreButton").on("click", function() {
                        f()
                    }).css({
                        position: "relative",
                        height: "100%"
                ...
                c = function(n) {
                    e(n).find("*:not(script)").each(function() {
                        ...
                        } else "img" == e(this).get(0).nodeName.toLowerCase() && "undefined" != typeof e(this).attr("src") && (n = e(this).attr("src"));
                        n.length > 0 && t.push(n)
                    })
                },
                u = function() {
                ...
                p = function() {
                    ...
                    if (e(jBar).stop().animate({
                            ...
                            easing: "linear",
                            step: function() {
                                jPer.html(parseInt(e(this)[0].style.width) + "%"), e(this).css("overflow", "visible")
                            }
                        }), r.showPercentage && e(jPer).text(n + "%"), o >= t.length) {
                        if (o = t.length, a(), r.showPercentage && e(jPer).text("100%"), r.debugMode) {
                            h()
                        }
                        e(jBar).stop().animate({
                            width: "100%"
                ...
                f = function() {
                    jOverlay.addClass("_hidden"), setTimeout(function() {
                        e(jOverlay).remove(), i()
                    }, 700)
                },
                h = function() {
            ...
            e.fn.f = function(t, n) {
                return t && e.extend(r, t), "function" == typeof n && (i = n), e("body").css({
                    ...
                    s() ? (e(r.splashID).remove(), i()) : (l(), c(this), u())
                })
            }
        }(jQuery)
    }, {}],
        ...
        ! function(e) {
            e.fn.extend({
                airport: function(t) {
                    ...
                    function i(n, s, a, l) {
                        e(o).find(".c" + n).html(" " == r[s] ? "&nbsp;" : r[s]), setTimeout(function() {
                    ...
                    var o = e(this),
                        ...
                        s = 0,
                        a = items2 = t.length;
                    for (e(this).empty(); a--;) t[a].length > s && (s = t[a].length);
                    for (; items2--;) t[items2] = n(t[items2], s);
                    for (spans = s; spans--;) e(this).prepend("<span class='c" + spans + "'></span>");
                    i(0, 0, 0, 0)
                }
            })
        }(jQuery)
            ...
            e.fn.fullpage = function(t) {
                ...
                function r() {
                    ...
                    if (!t.autoScrolling && !r.hasClass("active")) {
                        ...
                        if (u.length) var d = u.data("anchor"),
                            p = u.index();
                        r.addClass("active").siblings().removeClass("active"), ge || (e.isFunction(t.onLeave) && t.onLeave.call(this, s, c, a, l), e.isFunction(t.afterLoad) && t.afterLoad.call(this, l, c)), P(l, 0), t.anchors.length && !ge && (ae = l, q(p, d, l, c)), clearTimeout(xe), xe = setTimeout(function() {
                            Se = !1
                        }, 100)
                    }
                    t.scrollBar && (clearTimeout(be), be = setTimeout(function() {
                        ge || h(r)
                    }, 1e3))
                }

                function s(e) {
                    return e.find(".fp-slides").length ? scrollable = e.find(".fp-slide.active").find(".fp-scrollable") : scrollable = e.find(".fp-scrollable"), scrollable
                }

                function a(t, n) {
                    if (ye[t]) {
                        if ("down" == t) var i = "bottom",
                ...
                function l(n) {
                    ...
                    if (!c(n.target)) {
                        ...
                        if (!ge && !ue) {
                            var l = K(i);
                            ke = l.y, Ee = l.x, o.find(".fp-slides").length && Math.abs(Ce - Ee) > Math.abs(Te - ke) ? Math.abs(Ce - Ee) > e(window).width() / 100 * t.touchSensitivity && (Ce > Ee ? ye.right && e.fn.fullpage.moveSlideRight() : ye.left && e.fn.fullpage.moveSlideLeft()) : t.autoScrolling && !t.scrollBar && Math.abs(Te - ke) > e(window).height() / 100 * t.touchSensitivity && (Te > ke ? a("down", r) : ke > Te && a("up", r))
                        }
                    }
                }
                ...
                function d(n) {
                    if (t.autoScrolling) {
                        ...
                        var o = e(".fp-section.active"),
                            r = s(o);
                        return ge || (0 > i ? a("down", r) : a("up", r)), !1
                    }
                }
                ...
                function p(n) {
                    ...
                    if (o.length && !ue) {
                        var r = o.find(".fp-slide.active"),
                            s = null;
                        if (s = "prev" === n ? r.prev(".fp-slide") : r.next(".fp-slide"), !s.length) {
                ...
                function h(n, i, o) {
                    ...
                    if ("undefined" != typeof r) {
                        ...
                        if (!(s.activeSection.is(n) && !me || t.scrollBar && e(window).scrollTop() === s.dtop)) {
                            if (s.activeSlide.length) var a = s.activeSlide.data("anchor"),
                                l = s.activeSlide.index();
                            t.autoScrolling && t.continuousVertical && "undefined" != typeof s.isMovementUp && (!s.isMovementUp && "up" == s.yMovement || s.isMovementUp && "down" == s.yMovement) && (s = v(s)), n.addClass("active").siblings().removeClass("active"), ge = !0, q(l, a, s.anchorLink, s.sectionIndex), e.isFunction(t.onLeave) && !s.localIsResizing && t.onLeave.call(this, s.leavingSection, s.sectionIndex + 1, s.yMovement, s.anchorLink), e.isDevice || ("down" == s.yMovement ? n.prev().find(".fp-tableCell > .slider-item").addClass("_moveDown") : n.find(".fp-tableCell > .slider-item").removeClass("_moveDown").end().nextAll().find(".fp-tableCell > .slider-item").removeClass("_moveDown")), g(s), ae = s.anchorLink, t.autoScrolling && P(s.anchorLink, s.sectionIndex)
                        }
                    }
                }
                ...
                function g(n) {
                    if (t.css3 && t.autoScrolling && !t.scrollBar) {
                        var i = "";
                        i = "translate3d(0px, -" + n.dtop + "px, 0px)", _(i, !0), setTimeout(function() {
                            w(n)
                        }, t.scrollingSpeed)
                    } else {
                        var o = m(n);
                ...
                function v(t) {
                    return t.isMovementUp ? e(".fp-section.active").before(t.activeSection.nextAll(".fp-section")) : e(".fp-section.active").after(t.activeSection.prevAll(".fp-section").get().reverse()), J(e(".fp-section.active").position().top), f(), t.wrapAroundElements = t.activeSection, t.dest = t.element.position(), t.dtop = t.dest.top, t.yMovement = j(t.element), t
                }

                function y(t) {
                    t.wrapAroundElements && t.wrapAroundElements.length && (t.isMovementUp ? e(".fp-section:first").before(t.wrapAroundElements) : e(".fp-section:last").after(t.wrapAroundElements), J(e(".fp-section.active").position().top), f())
                }

                function w(n) {
                    y(n), e.isFunction(t.afterLoad) && !n.localIsResizing && t.afterLoad.call(this, n.anchorLink, n.sectionIndex + 1), setTimeout(function() {
                        ge = !1, e.isFunction(n.callback) && n.callback.call(this)
                    }, se)
                }
                ...
                function S(n, i) {
                    ...
                    i.addClass("active").siblings().removeClass("active"), "undefined" == typeof d && (d = s), !t.loopHorizontal && t.controlArrows && (a.find(".fp-controlArrow.fp-prev").toggle(0 != s), a.find(".fp-controlArrow.fp-next").toggle(!i.is(":last-child"))), a.hasClass("active") && q(s, d, c, l);
                    var g = function() {
                        p || e.isFunction(t.afterSlideLoad) && t.afterSlideLoad.call(this, c, l + 1, d, s), ue = !1
                    };
                    if (t.css3) {
                        var m = "translate3d(-" + o.left + "px, 0px, 0px)";
                        k(n.find(".fp-slidesContainer"), t.scrollingSpeed > 0).css(ee(m)), setTimeout(function() {
                            g()
                    ...
                    u.find(".active").removeClass("active"), u.find("li").eq(s).find("a").addClass("active")
                }
                ...
                function T() {
                    if (C(), de) {
                        if ("text" !== e(document.activeElement).attr("type")) {
                            ...
                            Math.abs(t - Le) > 20 * Math.max(Le, t) / 100 && (e.fn.fullpage.reBuild(!0), Le = t)
                        }
                    } else clearTimeout(Me), Me = setTimeout(function() {
                ...
                function C() {
                    if (t.responsive) {
                        ...
                        e(window).width() < t.responsive ? n || (e.fn.fullpage.setAutoScrolling(!1, "internal"), e("#fp-nav").hide(), fe.addClass("fp-responsive")) : n && (e.fn.fullpage.setAutoScrolling(we.autoScrolling, "internal"), e("#fp-nav").show(), fe.removeClass("fp-responsive"))
                    }
                }
                ...
                function L(n, i) {
                    t.navigation && (e("#fp-nav").find(".active").removeClass("active"), n ? e("#fp-nav").find('a[href="#' + n + '"]').addClass("active") : e("#fp-nav").find("li").eq(i).find("a").addClass("active"))
                }
                ...
                function H(e) {
                    ...
                    if (i.length) var o = i.get(0).scrollHeight;
                    else {
                    ...
                    o > r ? i.length ? i.css("height", r + "px").parent().css("height", r + "px") : (t.verticalCentered ? e.find(".fp-tableCell").wrapInner('<div class="fp-scrollable" />') : e.wrapInner('<div class="fp-scrollable" />'), e.find(".fp-scrollable").slimScroll({
                        allowPageScroll: !0,
                        height: r + "px",
                        size: "10px",
                        alwaysVisible: !0
                ...
                function _(e, t) {
                    t ? k(fe) : E(fe), fe.css(ee(e)), setTimeout(function() {
                        fe.removeClass("fp-notransition")
                    }, 10)
                }

                function R(t, n) {
                    if ("undefined" == typeof n && (n = 0), isNaN(t)) var i = e('[data-anchor="' + t + '"]');
                    else var i = e(".fp-section").eq(t - 1);
                ...
                function W(e, t) {
                    if ("undefined" != typeof t) {
                        ...
                        i.length || (i = n.find(".fp-slide").eq(t)), i.length && S(n, i)
                    }
                }
                ...
                function B(e, n) {
                    ...
                    for (var o = 0; n > o; o++) i.find("ul").append('<li><a href="#"><span></span></a></li>');
                    i.css("margin-left", "-" + i.width() / 2 + "px"), i.find("li").first().find("a").addClass("active")
                }

                function q(e, n, i, o) {
                    var r = "";
                    t.anchors.length ? (e ? ("undefined" != typeof i && (r = i), "undefined" == typeof n && (n = e), le = n, z(r + "/" + n)) : "undefined" != typeof e ? (le = n, z(i)) : z(i), X(location.hash)) : X("undefined" != typeof e ? o + "-" + e : String(o))
                }

                function z(e) {
                    if (t.recordHistory) location.hash = e;
                    else if (de || pe) history.replaceState(void 0, void 0, "#" + e);
                    else {
                ...
                function X(t) {
                    t = t.replace("/", "-").replace("#", ""), e("body")[0].className = e("body")[0].className.replace(/\b\s?fp-viewing-[^\s]+\b/g, ""), e("body").addClass("fp-viewing-" + t)
                }
                ...
                function G() {
                    (de || pe) && (MSPointer = Q(), e(document).off("touchstart " + MSPointer.down).on("touchstart " + MSPointer.down, u), e(document).off("touchmove " + MSPointer.move).on("touchmove " + MSPointer.move, l))
                }

                function U() {
                    (de || pe) && (MSPointer = Q(), e(document).off("touchstart " + MSPointer.down), e(document).off("touchmove " + MSPointer.move))
                }
                ...
                function Z(t) {
                    e.fn.fullpage.setScrollingSpeed(0, "internal"), S(t.closest(".fp-slides"), t), e.fn.fullpage.setScrollingSpeed(we.scrollingSpeed, "internal")
                }

                function J(e) {
                    if (t.scrollBar) fe.scrollTop(e);
                    else if (t.css3) {
                        var n = "";
                        n = "translate3d(0px, -" + e + "px, 0px)", _(n, !1)
                    } else fe.css("top", -e)
                }
                ...
                function ne() {
                    J(0), e("#fp-nav, .fp-slidesNav, .fp-controlArrow").remove(), e(".fp-section").css({
                        height: "",
                        "background-color": "",
                        padding: ""
                    }), e(".fp-slide").css({
                        ...
                        I(e(this)), e(this).removeClass("fp-table active")
                    }), E(fe), E(fe.find(".fp-easing")), fe.find(".fp-tableCell, .fp-slidesContainer, .fp-slides").each(function() {
                        e(this).replaceWith(this.childNodes)
                    }), e("html, body").scrollTop(0)
                }

                function ie(e, n, i) {
                    t[e] = n, "internal" !== i && (we[e] = n)
                }

                function oe() {
                    t.continuousVertical && (t.loopTop || t.loopBottom) && (t.continuousVertical = !1, re("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), t.continuousVertical && t.scrollBar && (t.continuousVertical = !1, re("warn", "Option `scrollBar` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), e.each(t.anchors, function(t, n) {
                ...
                e.fn.fullpage.setAutoScrolling = function(n, i) {
                    ...
                    t.autoScrolling && !t.scrollBar ? (e("html, body").css({
                        overflow: "hidden",
                        height: "100%"
                    }), e.fn.fullpage.setRecordHistory(t.recordHistory, "internal"), fe.css({
                        "-ms-touch-action": "none",
                        "touch-action": "none"
                    }), o.length && J(o.position().top)) : (e("html, body").css({
                        overflow: "visible",
                        height: "initial"
                    }), e.fn.fullpage.setRecordHistory(!1, "internal"), fe.css({
                        "-ms-touch-action": "",
                        "touch-action": ""
                    }), J(0), e("html, body").scrollTop(o.position().top))
                    ...
                    "undefined" != typeof n ? (n = n.replace(" ", "").split(","), e.each(n, function(e, n) {
                        te(t, n)
                    })) : t ? (e.fn.fullpage.setMouseWheelScrolling(!0), G()) : (e.fn.fullpage.setMouseWheelScrolling(!1), U())
                    ...
                    n.length || !t.loopTop && !t.continuousVertical || (n = e(".fp-section").last()), n.length && h(n, null, !0)
                }, e.fn.fullpage.moveSectionDown = function() {
                    var n = e(".fp-section.active").next(".fp-section");
                    n.length || !t.loopBottom && !t.continuousVertical || (n = e(".fp-section").first()), n.length && h(n, null, !1)
                }, e.fn.fullpage.moveTo = function(t, n) {
                    var i = "";
                    i = isNaN(t) ? e('[data-anchor="' + t + '"]') : e(".fp-section").eq(t - 1), "undefined" != typeof n ? R(t, n) : i.length > 0 && h(i)
                    ...
                    he = e(window).height(), t.resize && M(he, i), e(".fp-section").each(function() {
                        he - parseInt(e(this).css("padding-bottom")) - parseInt(e(this).css("padding-top"));
                        if (t.verticalCentered && e(this).find(".fp-tableCell").css("height", O(e(this)) + "px"), e(this).css("height", he + "px"), t.scrollOverflow) {
                    ...
                    var o = (e(".fp-section.active").position(), e(".fp-section.active"));
                    o.index(".fp-section") && h(o), me = !1, e.isFunction(t.afterResize) && n && t.afterResize.call(this), e.isFunction(t.afterReBuild) && !n && t.afterReBuild.call(this)
                };
                var ae, le, ce, ue = !1,
                    de = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|Windows Phone|Tizen|Bada)/),
                    pe = "ontouchstart" in window || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints,
                    fe = e(this),
                    he = e(window).height(),
                    ge = !1,
                    me = !1,
                ...
                e.fn.fullpage.setAllowScrolling(!0), t.css3 && (t.css3 = Y()), e(this).length ? (fe.css({
                    height: "100%",
                    position: "relative"
                }), fe.addClass(ve)) : re("error", "Error! Fullpage.js needs to be initialized with a selector. For example: $('#myContainer').fullpage();"), e(t.sectionSelector).each(function() {
                    ...
                    var o = e(this),
                        ...
                        s = r.length;
                    if (i || 0 !== e(".fp-section.active").length || e(this).addClass("active"), e(this).css("height", he + "px"), (t.paddingTop || t.paddingBottom) && e(this).css("padding", t.paddingTop + " 0 " + t.paddingBottom + " 0"), "undefined" != typeof t.sectionsColor[i] && e(this).css("background-color", t.sectionsColor[i]), "undefined" != typeof t.anchors[i] && e(this).attr("data-anchor", t.anchors[i]), s > 1) {
                        var a = 100 * s,
                            l = 100 / s;
                        r.wrapAll('<div class="fp-slidesContainer" />'), r.parent().wrap('<div class="fp-slides" />'), e(this).find(".fp-slidesContainer").css("width", a + "%"), t.controlArrows && n(e(this)), t.slidesNavigation && B(e(this), s), r.each(function(n) {
                            e(this).css("width", l + "%"), t.verticalCentered && F(e(this))
                        });
                        var c = o.find(".fp-slide.active");
                        0 == c.length ? r.eq(0).addClass("active") : Z(c)
                    } else t.verticalCentered && F(e(this))
                }).promise().done(function() {
                    e.fn.fullpage.setAutoScrolling(t.autoScrolling, "internal");
                    var n = e(".fp-section.active").find(".fp-slide.active");
                    n.length && (0 != e(".fp-section.active").index(".fp-section") || 0 == e(".fp-section.active").index(".fp-section") && 0 != n.index()) && Z(n), t.fixedElements && t.css3 && e(t.fixedElements).appendTo("body"), t.navigation && (ce.css("margin-top", "-" + ce.height() / 2 + "px"), ce.find("li").eq(e(".fp-section.active").index(".fp-section")).find("a").addClass("active")), t.menu && t.css3 && e(t.menu).closest(".fullpage-wrapper").length && e(t.menu).appendTo("body"), t.scrollOverflow ? ("complete" === document.readyState && o(), e(window).on("load", o)) : e.isFunction(t.afterRender) && t.afterRender.call(this), C();
                    var i = window.location.hash.replace("#", "").split("/"),
                        r = i[0];
                    if (r.length) {
                        var s = e('[data-anchor="' + r + '"]');
                        !t.animateAnchor && s.length && (t.autoScrolling ? J(s.position().top) : (J(0), X(r), e("html, body").scrollTop(s.position().top)), P(r, null), e.isFunction(t.afterLoad) && t.afterLoad.call(this, r, s.index(".fp-section") + 1), s.addClass("active").siblings().removeClass("active"))
                    }
                ...
                var Te = 0,
                    ...
                    ke = 0,
                    Ee = 0;
                e(window).on("hashchange", b), e(document).keydown(function(n) {
                    if (t.keyboardScrolling && t.autoScrolling && ((40 == n.which || 38 == n.which) && n.preventDefault(), !ge)) switch (n.which) {
                        case 38:
                        case 33:
                ...
                e.fn.fullpage.destroy = function(n) {
                    e.fn.fullpage.setAutoScrolling(!1, "internal"), e.fn.fullpage.setAllowScrolling(!1), e.fn.fullpage.setKeyboardScrolling(!1), e(window).off("scroll", r).off("hashchange", b).off("resize", T), e(document).off("click", "#fp-nav a").off("mouseenter", "#fp-nav li").off("mouseleave", "#fp-nav li").off("click", ".fp-slidesNav a").off("mouseover", t.normalScrollElements).off("mouseout", t.normalScrollElements), e(".fp-section").off("click", ".fp-controlArrow"), n && ne()
                }
            }
        }(jQuery)
    }, {}],
    8: [function(e, t, n) { /*! jQuery v2.1.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */
        ! function(e, n) {
            ...
            function s() {
                Z.removeEventListener("DOMContentLoaded", s, !1), e.removeEventListener("load", s, !1), ee.ready()
            }
            ...
            function m(e, t) {
                ...
                if (1 === t.nodeType) {
                    if (ve.hasData(e) && (r = ve.access(e), s = ve.set(t, r), c = r.events)) {
                        ...
                        for (o in c)
                            for (n = 0, i = c[o].length; i > n; n++) ee.event.add(t, o, c[o][n])
                    }
                    ye.hasData(e) && (a = ye.access(e), l = ee.extend({}, a), ye.set(t, l))
                }
            }
            ...
            function x(e) {
                var t = Z,
                    n = We[e];
                return n || (n = w(e, t), "none" !== n && n || (Re = (Re || ee("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Re[0].contentDocument, t.write(), t.close(), n = w(e, t), Re.detach()), We[e] = n), n
            }

            function b(e, t, n) {
                var i, o, r, s, a = e.style;
                return n = n || ze(e), n && (s = n.getPropertyValue(t) || n[t]), n && ("" !== s || ee.contains(e.ownerDocument, e) || (s = ee.style(e, t)), qe.test(s) && Be.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
            }
            ...
            function k(e, t, n, i, o) {
                for (var r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > r; r += 2) "margin" === n && (s += ee.css(e, n + Se[r], !0, o)), i ? ("content" === n && (s -= ee.css(e, "padding" + Se[r], !0, o)), "margin" !== n && (s -= ee.css(e, "border" + Se[r] + "Width", !0, o))) : (s += ee.css(e, "padding" + Se[r], !0, o), "padding" !== n && (s += ee.css(e, "border" + Se[r] + "Width", !0, o)));
                return s
            }
            ...
            function E(e, t, n) {
                ...
                if (0 >= o || null == o) {
                    if (o = b(e, t, r), (0 > o || null == o) && (o = e.style[t]), qe.test(o)) return o;
            ...
            function M(e, t) {
                for (var n, i, o, r = [], s = 0, a = e.length; a > s; s++) i = e[s], i.style && (r[s] = ve.get(i, "olddisplay"), n = i.style.display, t ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Te(i) && (r[s] = ve.access(i, "olddisplay", x(i.nodeName)))) : r[s] || (o = Te(i), (n && "none" !== n || !o) && ve.set(i, "olddisplay", o ? n : ee.css(i, "display"))));
            ...
            function j(e, t, n) {
                ...
                })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], c = ee.css(e, "display"), "none" === c && (c = x(e.nodeName)), "inline" === c && "none" === ee.css(e, "float") && (p.display = "inline-block")), n.overflow && (p.overflow = "hidden", u.always(function() {
                ...
                if (!ee.isEmptyObject(d)) {
                    h ? "hidden" in h && (f = h.hidden) : h = ve.access(e, "fxshow", {}), r && (h.hidden = !f), f ? ee(e).show() : u.done(function() {
                        ee(e).hide()
                    }), u.done(function() {
                        var t;
                        ve.remove(e, "fxshow");
                    ...
                    for (i in d) s = D(f ? h[i] : 0, i, u), i in h || (h[i] = s.start, f && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
                }
            }
            ...
            function N(e, t) {
                var n, i, o, r, s;
                for (n in e)
                    if (i = ee.camelCase(n), o = t[i], r = e[n], ee.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), s = ee.cssHooks[i], s && "expand" in s) {
            ...
            function H(e, t, n) {
                var i, o, r = 0,
                    ...
                    l = function() {
                        if (o) return !1;
                        for (var t = Qe || A(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++) c.tweens[s].run(r);
            ...
            function W(e, t, n, i) {
                var o;
                if (ee.isArray(t)) ee.each(t, function(t, o) {
            ...
            ee.fn = ee.prototype = {
                ...
                for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || ee.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++)
                    if (null != (e = arguments[a]))
                        for (t in e) n = s[t], i = e[t], s !== i && (c && i && (ee.isPlainObject(i) || (o = ee.isArray(i))) ? (o ? (o = !1, r = n && ee.isArray(n) ? n : []) : r = n && ee.isPlainObject(n) ? n : {}, s[t] = ee.extend(c, r, i)) : void 0 !== i && (s[t] = i));
                return s
            }, ee.extend({
                ...
                isPlainObject: function(e) {
                    ...
                    try {
                        if (e.constructor && !U.call(e.constructor.prototype, "isPrototypeOf")) return !1
                    } catch (t) {
                        return !1
                    }
                    return !0
                ...
                globalEval: function(e) {
                    var t, n = eval;
                    e = ee.trim(e), e && (1 === e.indexOf("use strict") ? (t = Z.createElement("script"), t.text = e, Z.head.appendChild(t).parentNode.removeChild(t)) : n(e))
                },
                ...
                proxy: function(e, t) {
                    var n, i, o;
                    return "string" == typeof t && (n = e[t], t = e, e = n), ee.isFunction(e) ? (i = z.call(arguments, 2), o = function() {
            ...
            var oe = function(e) {
                    ...
                    if (H && !i) {
                        if (o = ye.exec(e))
                            if (s = o[1]) {
                                ...
                                if ((s = o[3]) && T.getElementsByClassName && t.getElementsByClassName) return J.apply(n, t.getElementsByClassName(s)), n
                            }
                        if (T.qsa && (!I || !I.test(e))) {
                            if (h = d = R, g = t, m = 9 === a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
                                for (c = p(e), (d = t.getAttribute("id")) ? h = d.replace(xe, "\\$&") : t.setAttribute("id", h), h = "[id='" + h + "'] ", l = c.length; l--;) c[l] = h + f(c[l]);
                                g = we.test(e) && u(t.parentNode) || t, m = c.join(",")
                            }
                            if (m) try {
                ...
                function h(e, t, n) {
                    ...
                    return t.first ? function(t, n, r) {
                        ...
                        if (s) {
                            ...
                            for (; t = t[i];)
                                if (1 === t.nodeType || o) {
                                    if (l = t[R] || (t[R] = {}), (a = l[i]) && a[0] === B && a[1] === r) return c[2] = a[2];
                ...
                function v(e, t, n, o, r, s) {
                    return o && !o[R] && (o = v(o)), r && !r[R] && (r = v(r, s)), i(function(i, s, a, l) {
                        var c, u, d, p = [],
                            ...
                            v = !e || !i && t ? g : m(g, p, e, a, l),
                            y = n ? r || (i ? e : h || o) ? [] : s : v;
                        if (n && n(v, y, a, l), o)
                            for (c = m(y, f), o(c, [], a, l), u = c.length; u--;)(d = c[u]) && (y[f[u]] = !(v[f[u]] = d));
                        if (i) {
                            if (r || e) {
                                if (r) {
                                ...
                                for (u = y.length; u--;)(d = y[u]) && (c = r ? te.call(i, d) : p[u]) > -1 && (i[c] = !(s[c] = d))
                            }
                        } else y = m(y === s ? y.splice(h, y.length) : y), r ? r(null, s, y, l) : J.apply(s, y)
                    })
                }
                ...
                function b(e, t, n, i) {
                    var o, r, s, a, l, c = p(e);
                    if (!i && 1 === c.length) {
                        if (r = c[0] = c[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && T.getById && 9 === t.nodeType && H && C.relative[r[1].type]) {
                            if (t = (C.find.ID(s.matches[0].replace(be, Se), t) || [])[0], !t) return n;
                    ...
                    return M(e, c)(i, t, !H, n, we.test(e) && u(t.parentNode) || t), n
                }
                var S, T, C, k, E, M, L, A, P, D, j, N, H, I, F, O, _, R = "sizzle" + -new Date,
                    W = e.document,
                    B = 0,
                    q = 0,
                    z = n(),
                    ...
                    oe = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+",
                    re = oe.replace("w", "w#"),
                    se = "\\[" + ie + "*(" + oe + ")" + ie + "*(?:([*^$|!~]?=)" + ie + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + re + ")|)|)" + ie + "*\\]",
                    ae = ":(" + oe + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + se.replace(3, 8) + ")*)|.*)\\)|)",
                ...
                try {
                    J.apply(Q = ee.call(W.childNodes), W.childNodes), Q[W.childNodes.length].nodeType
                } catch (Te) {
                    J = {
                ...
                T = t.support = {}, E = t.isXML = function(e) {
                    ...
                    var t, n = e ? e.ownerDocument || e : W,
                        i = n.defaultView;
                    return n !== j && 9 === n.nodeType && n.documentElement ? (j = n, N = n.documentElement, H = !E(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function() {
                        D()
                    ...
                    }, F = [], I = [], (T.qsa = ve.test(n.querySelectorAll)) && (o(function(e) {
                        ...
                        T.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), F.push("!=", ae)
                    }), I = I.length && new RegExp(I.join("|")), F = F.length && new RegExp(F.join("|")), t = ve.test(N.compareDocumentPosition), _ = t || ve.test(N.contains) ? function(e, t) {
                        ...
                        return i ? i : (i = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & i || !T.sortDetached && t.compareDocumentPosition(e) === i ? e === n || e.ownerDocument === W && _(W, e) ? -1 : t === n || t.ownerDocument === W && _(W, t) ? 1 : A ? te.call(A, e) - te.call(A, t) : 0 : 4 & i ? -1 : 1)
                    } : function(e, t) {
                        if (e === t) return P = !0, 0;
                        var i, o = 0,
                            r = e.parentNode,
                    ...
                    if ((e.ownerDocument || e) !== j && D(e), n = n.replace(de, "='$1']"), !(!T.matchesSelector || !H || F && F.test(n) || I && I.test(n))) try {
                        var i = O.call(e, n);
                    ...
                    var t, n = [],
                        i = 0,
                        o = 0;
                    if (P = !T.detectDuplicates, A = !T.sortStable && e.slice(0), e.sort(V), P) {
                    ...
                    preFilter: {
                        ATTR: function(e) {
                            return e[1] = e[1].replace(be, Se), e[3] = (e[4] || e[5] || "").replace(be, Se), "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0, 4)
                        },
                        CHILD: function(e) {
                            ...
                            return 1 === i && 0 === o ? function(e) {
                                ...
                                if (m) {
                                    ...
                                    if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                        ...
                                        for (;
                                            (d = ++f && d && d[g] || (p = f = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++p || (y && ((d[R] || (d[R] = {}))[e] = [B, p]), d !== t)););
                    ...
                    pseudos: {
                        ...
                        lang: i(function(e) {
                            return fe.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(be, Se).toLowerCase(),
                                function(t) {
                                    var n;
                                    do
                ...
                return d.prototype = C.filters = C.pseudos, C.setFilters = new d, M = t.compile = function(e, t) {
                    var n, i = [],
                        o = [],
                        r = Y[e + " "];
                    if (!r) {
                        for (t || (t = p(e)), n = t.length; n--;) r = y(t[n]), r[R] ? i.push(r) : o.push(r);
                        r = Y(e, w(o, i))
                    }
                    return r
                }, T.sortStable = R.split("").sort(V).join("") === R, T.detectDuplicates = !!P, D(), T.sortDetached = o(function(e) {
            ...
            var le, ce = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
                ue = ee.fn.init = function(e, t) {
                    ...
                    if ("string" == typeof e) {
                        ...
                        if (n[1]) {
                            if (t = t instanceof ee ? t[0] : t, ee.merge(this, ee.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : Z, !0)), se.test(n[1]) && ee.isPlainObject(t))
            ...
            ee.extend({
                ...
                ee.fn[e] = function(n, i) {
                    ...
                    return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = ee.filter(i, o)), this.length > 1 && (pe[e] || ee.unique(o), de.test(e) && o.reverse()), this.pushStack(o)
                }
            });
            var fe = /\S+/g,
                he = {};
            ee.Callbacks = function(e) {
                    ...
                    d = {
                        ...
                        remove: function() {
                            return l && ee.each(arguments, function(e, t) {
                                for (var n;
                                    (n = ee.inArray(t, l, n)) > -1;) l.splice(n, 1), i && (s >= n && s--, a >= n && a--)
                            }), this
                        },
                        has: function(e) {
                ...
                Deferred: function(e) {
                    var t = [
                        ...
                        o = {};
                    return i.pipe = i.then, ee.each(t, function(e, r) {
                        var s = r[2],
                            a = r[3];
                ...
                when: function(e) {
                    ...
                    if (s > 1)
                        for (t = new Array(s), n = new Array(s), i = new Array(s); s > o; o++) r[o] && ee.isFunction(r[o].promise) ? r[o].promise().done(c(o, i, r)).fail(l.reject).progress(c(o, n, t)) : --a;
            ...
            ee.fn.ready = function(e) {
                ...
                ready: function(e) {
                    (e === !0 ? --ee.readyWait : ee.isReady) || (ee.isReady = !0, e !== !0 && --ee.readyWait > 0 || (ge.resolveWith(Z, [ee]), ee.fn.trigger && ee(Z).trigger("ready").off("ready")))
                }
            }), ee.ready.promise = function(t) {
                return ge || (ge = ee.Deferred(), "complete" === Z.readyState ? setTimeout(ee.ready) : (Z.addEventListener("DOMContentLoaded", s, !1), e.addEventListener("load", s, !1))), ge.promise(t)
            }, ee.ready.promise();
            var me = ee.access = function(e, t, n, i, o, r, s) {
                ...
                if ("object" === ee.type(n)) {
                    o = !0;
                    for (a in n) ee.access(e, t, a, n[a], !0, r, s)
                } else if (void 0 !== i && (o = !0, ee.isFunction(i) || (s = !0), c && (s ? (t.call(e, i), t = null) : (c = t, t = function(e, t, n) {
            ...
            ee.acceptData = function(e) {
                ...
                set: function(e, t, n) {
                    ...
                    else if (ee.isEmptyObject(r)) ee.extend(this.cache[o], t);
                    else
                        for (i in t) r[i] = t[i];
                    return r
                },
                ...
                remove: function(e, t) {
                    ...
                    if (void 0 === t) this.cache[r] = {};
                        ...
                        ee.isArray(t) ? i = t.concat(t.map(ee.camelCase)) : (o = ee.camelCase(t), t in s ? i = [t, o] : (i = o, i = i in s ? [i] : i.match(fe) || [])), n = i.length;
                        for (; n--;) delete s[i[n]]
                    }
                },
                hasData: function(e) {
                ...
                data: function(e, t) {
                    ...
                    if (void 0 === e) {
                        if (this.length && (o = ye.get(r), 1 === r.nodeType && !ve.get(r, "hasDataAttrs"))) {
                            for (n = s.length; n--;) i = s[n].name, 0 === i.indexOf("data-") && (i = ee.camelCase(i.slice(5)), l(r, i, o[i]));
            ...
            ee.event = {
                ...
                add: function(e, t, n, i, o) {
                    ...
                    if (m)
                        for (n.handler && (r = n, n = r.handler, o = r.selector), n.guid || (n.guid = ee.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                                return typeof ee !== ke && ee.event.triggered !== t.type ? ee.event.dispatch.apply(e, arguments) : void 0
                            }), t = (t || "").match(fe) || [""], c = t.length; c--;) a = Ae.exec(t[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f && (d = ee.event.special[f] || {}, f = (o ? d.delegateType : d.bindType) || f, d = ee.event.special[f] || {}, u = ee.extend({
                            type: f,
                            origType: g,
                            data: i,
                            handler: n,
                            ...
                            namespace: h.join(".")
                        }, r), (p = l[f]) || (p = l[f] = [], p.delegateCount = 0, d.setup && d.setup.call(e, i, h, s) !== !1 || e.addEventListener && e.addEventListener(f, s, !1)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, u) : p.push(u), ee.event.global[f] = !0)
                },
                remove: function(e, t, n, i, o) {
                    var r, s, a, l, c, u, d, p, f, h, g, m = ve.hasData(e) && ve.get(e);
                    if (m && (l = m.events)) {
                        for (t = (t || "").match(fe) || [""], c = t.length; c--;)
                            if (a = Ae.exec(t[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
                                for (d = ee.event.special[f] || {}, f = (i ? d.delegateType : d.bindType) || f, p = l[f] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = p.length; r--;) u = p[r], !o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (p.splice(r, 1), u.selector && p.delegateCount--, d.remove && d.remove.call(e, u));
                                s && !p.length && (d.teardown && d.teardown.call(e, h, m.handle) !== !1 || ee.removeEvent(e, f, m.handle), delete l[f])
                            } else
                                for (f in l) ee.event.remove(e, f + t[c], n, i, !0);
                        ee.isEmptyObject(l) && (delete m.handle, ve.remove(e, "events"))
                    }
                },
                trigger: function(t, n, i, o) {
                    var r, s, a, l, c, u, d, p = [i || Z],
                        f = U.call(t, "type") ? t.type : t,
                        h = U.call(t, "namespace") ? t.namespace.split(".") : [];
                    if (s = a = i = i || Z, 3 !== i.nodeType && 8 !== i.nodeType && !Le.test(f + ee.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), c = f.indexOf(":") < 0 && "on" + f, t = t[ee.expando] ? t : new ee.Event(f, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : ee.makeArray(n, [t]), d = ee.event.special[f] || {}, o || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                        if (!o && !d.noBubble && !ee.isWindow(i)) {
                            for (l = d.delegateType || f, Le.test(l + f) || (s = s.parentNode); s; s = s.parentNode) p.push(s), a = s;
                            a === (i.ownerDocument || Z) && p.push(a.defaultView || a.parentWindow || e)
                        }
                        for (r = 0;
                            (s = p[r++]) && !t.isPropagationStopped();) t.type = r > 1 ? l : d.bindType || f, u = (ve.get(s, "events") || {})[t.type] && ve.get(s, "handle"), u && u.apply(s, n), u = c && s[c], u && u.apply && ee.acceptData(s) && (t.result = u.apply(s, n), t.result === !1 && t.preventDefault());
                        return t.type = f, o || t.isDefaultPrevented() || d._default && d._default.apply(p.pop(), n) !== !1 || !ee.acceptData(i) || c && ee.isFunction(i[f]) && !ee.isWindow(i) && (a = i[c], a && (i[c] = null), ee.event.triggered = f, i[f](), ee.event.triggered = void 0, a && (i[c] = a)), t.result
                    }
                },
                dispatch: function(e) {
                    e = ee.event.fix(e);
                    ...
                    if (a[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
                        for (s = ee.event.handlers.call(this, e, l), t = 0;
                            ...
                            for (e.currentTarget = o.elem, n = 0;
                                (r = o.handlers[n++]) && !e.isImmediatePropagationStopped();)(!e.namespace_re || e.namespace_re.test(r.namespace)) && (e.handleObj = r, e.data = r.data, i = ((ee.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a), void 0 !== i && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
                    ...
                    if (a && l.nodeType && (!e.button || "click" !== e.type))
                        for (; l !== this; l = l.parentNode || this)
                            if (l.disabled !== !0 || "click" !== e.type) {
                                for (i = [], n = 0; a > n; n++) r = t[n], o = r.selector + " ", void 0 === i[o] && (i[o] = r.needsContext ? ee(o, this).index(l) >= 0 : ee.find(o, this, null, [l]).length), i[o] && i.push(r);
                                i.length && s.push({
                                    elem: l,
                                    handlers: i
                                })
                ...
                fix: function(e) {
                    ...
                    var t, n, i, o = e.type,
                        r = e,
                        s = this.fixHooks[o];
                    for (s || (this.fixHooks[o] = s = Me.test(o) ? this.mouseHooks : Ee.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new ee.Event(r), t = i.length; t--;) n = i[t], e[n] = r[n];
                ...
                simulate: function(e, t, n, i) {
                    ...
                    i ? ee.event.trigger(o, null, t) : ee.event.dispatch.call(t, o), o.isDefaultPrevented() && n.preventDefault()
                }
                ...
                on: function(e, t, n, i, o) {
                    ...
                    return 1 === o && (r = i, i = function(e) {
                        return ee().off(e), r.apply(this, arguments)
                    }, i.guid = r.guid || (r.guid = ee.guid++)), this.each(function() {
            ...
            _e.optgroup = _e.option, _e.tbody = _e.tfoot = _e.colgroup = _e.caption = _e.thead, _e.th = _e.td, ee.extend({
                ...
                buildFragment: function(e, t, n, i) {
                    for (var o, r, s, a, l, c, u = t.createDocumentFragment(), d = [], p = 0, f = e.length; f > p; p++)
                        if (o = e[p], o || 0 === o)
                            if ("object" === ee.type(o)) ee.merge(d, o.nodeType ? [o] : o);
                            else if (je.test(o)) {
                        for (r = r || u.appendChild(t.createElement("div")), s = (De.exec(o) || ["", ""])[1].toLowerCase(), a = _e[s] || _e._default, r.innerHTML = a[1] + o.replace(Pe, "<$1></$2>") + a[2], c = a[0]; c--;) r = r.lastChild;
                        ee.merge(d, r.childNodes), r = u.firstChild, r.textContent = ""
                    } else d.push(t.createTextNode(o));
                    for (u.textContent = "", p = 0; o = d[p++];)
                        if ((!i || -1 === ee.inArray(o, i)) && (l = ee.contains(o.ownerDocument, o), r = v(u.appendChild(o), "script"), l && g(r), n))
                            for (c = 0; o = r[c++];) Ie.test(o.type || "") && n.push(o);
                    return u
                },
                cleanData: function(e) {
                    for (var t, n, i, o, r, s, a = ee.event.special, l = 0; void 0 !== (n = e[l]); l++) {
                        if (ee.acceptData(n) && (r = n[ve.expando], r && (t = ve.cache[r]))) {
                            if (i = Object.keys(t.events || {}), i.length)
                                for (s = 0; void 0 !== (o = i[s]); s++) a[o] ? ee.event.remove(n, o) : ee.removeEvent(n, o, t.handle);
                ...
                remove: function(e, t) {
                    for (var n, i = e ? ee.filter(e, this) : this, o = 0; null != (n = i[o]); o++) t || 1 !== n.nodeType || ee.cleanData(v(n)), n.parentNode && (t && ee.contains(n.ownerDocument, n) && g(v(n, "script")), n.parentNode.removeChild(n));
                    return this
                },
                empty: function() {
                ...
                domManip: function(e, t) {
                    ...
                    var n, i, o, r, s, a, l = 0,
                        ...
                        p = e[0],
                        g = ee.isFunction(p);
                    if (g || c > 1 && "string" == typeof p && !K.checkClone && He.test(p)) return this.each(function(n) {
                        var i = u.eq(n);
                    ...
                    if (c && (n = ee.buildFragment(e, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                        for (o = ee.map(v(n, "script"), f), r = o.length; c > l; l++) s = n, l !== d && (s = ee.clone(s, !0, !0), r && ee.merge(o, v(s, "script"))), t.call(this[l], s, l);
                        if (r)
                            for (a = o[o.length - 1].ownerDocument, ee.map(o, h), l = 0; r > l; l++) s = o[l], Ie.test(s.type || "") && !ve.access(s, "globalEval") && ee.contains(a, s) && (s.src ? ee._evalUrl && ee._evalUrl(s.src) : ee.globalEval(s.textContent.replace(Oe, "")))
                    }
                    return this
                }
            }), ee.each({
                ...
                ee.fn[e] = function(e) {
                    for (var n, i = [], o = ee(e), r = o.length - 1, s = 0; r >= s; s++) n = s === r ? this : this.clone(!0), ee(o[s])[t](n), Y.apply(i, n.get());
            ...
            ! function() {
                function t() {
                    a.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%", r.appendChild(s);
                ...
                a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", K.clearCloneStyle = "content-box" === a.style.backgroundClip, s.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", s.appendChild(a), e.getComputedStyle && ee.extend(K, {
                    ...
                    reliableMarginRight: function() {
                        ...
                        return n.style.cssText = a.style.cssText = o, n.style.marginRight = n.style.width = "0", a.style.width = "1px", r.appendChild(s), t = !parseFloat(e.getComputedStyle(n, null).marginRight), r.removeChild(s), a.innerHTML = "", t
                    }
                })
            ...
            ee.extend({
                ...
                style: function(e, t, n, i) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        var o, r, s, a = ee.camelCase(t),
                            l = e.style;
                        return t = ee.cssProps[a] || (ee.cssProps[a] = T(l, a)), s = ee.cssHooks[t] || ee.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : l[t] : (r = typeof n, "string" === r && (o = Ve.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(ee.css(e, t)), r = "number"), void(null != n && n === n && ("number" !== r || ee.cssNumber[a] || (n += "px"), K.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l[t] = "", l[t] = n))))
                    }
                },
                css: function(e, t, n, i) {
                    var o, r, s, a = ee.camelCase(t);
                    return t = ee.cssProps[a] || (ee.cssProps[a] = T(e.style, a)), s = ee.cssHooks[t] || ee.cssHooks[a], s && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = b(e, t, i)), "normal" === o && t in Ge && (o = Ge[t]), "" === n || n ? (r = parseFloat(o), n === !0 || ee.isNumeric(r) ? r || 0 : o) : o
                }
                ...
                css: function(e, t) {
                    return me(this, function(e, t, n) {
                        var i, o, r = {},
                            s = 0;
                        if (ee.isArray(t)) {
                            for (i = ze(e), o = t.length; o > s; s++) r[t[s]] = ee.css(e, t[s], !1, i);
                            return r
                        }
            ...
            }), ee.Tween = L, L.prototype = {
                constructor: L,
                init: function(e, t, n, i, o, r) {
                    this.elem = e, this.prop = n, this.easing = o || "swing", this.options = t, this.start = this.now = this.cur(), this.end = i, this.unit = r || (ee.cssNumber[n] ? "" : "px")
                },
                cur: function() {
                ...
                run: function(e) {
                    ...
                    return this.pos = t = this.options.duration ? ee.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : L.propHooks._default.set(this), this
                }
            ...
            }, ee.fx = L.prototype.init, ee.fx.step = {};
            var Qe, Ke, Ze = /^(?:toggle|show|hide)$/,
                ...
                nt = {
                    "*": [function(e, t) {
                        ...
                        if (s && s[3] !== r) {
                            r = r || s[3], o = o || [], s = +i || 1;
                            do a = a || ".5", s /= a, ee.style(n.elem, e, s + r); while (a !== (a = n.cur() / i) && 1 !== a && --l)
                        }
            ...
            ee.fn.extend({
                ...
                attr: function(e, t, n) {
                    ...
                    return e && 3 !== r && 8 !== r && 2 !== r ? typeof e.getAttribute === ke ? ee.prop(e, t, n) : (1 === r && ee.isXMLDoc(e) || (t = t.toLowerCase(), i = ee.attrHooks[t] || (ee.expr.match.bool.test(t) ? ot : it)), void 0 === n ? i && "get" in i && null !== (o = i.get(e, t)) ? o : (o = ee.find.attr(e, t), null == o ? void 0 : o) : null !== n ? i && "set" in i && void 0 !== (o = i.set(e, n, t)) ? o : (e.setAttribute(t, n + ""), n) : void ee.removeAttr(e, t)) : void 0
                },
                removeAttr: function(e, t) {
                    var n, i, o = 0,
                        r = t && t.match(fe);
                    if (r && 1 === e.nodeType)
                        for (; n = r[o++];) i = ee.propFix[n] || n, ee.expr.match.bool.test(n) && (e[i] = !1), e.removeAttribute(n)
                },
                attrHooks: {
                    type: {
                        set: function(e, t) {
            ...
            ee.fn.extend({
                ...
                prop: function(e, t, n) {
                    ...
                    return e && 3 !== s && 8 !== s && 2 !== s ? (r = 1 !== s || !ee.isXMLDoc(e), r && (t = ee.propFix[t] || t, o = ee.propHooks[t]), void 0 !== n ? o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : e[t] = n : o && "get" in o && null !== (i = o.get(e, t)) ? i : e[t]) : void 0
                },
                propHooks: {
                    tabIndex: {
                        get: function(e) {
            ...
            ee.fn.extend({
                ...
                toggleClass: function(e, t) {
                    ...
                    return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(ee.isFunction(e) ? function(n) {
                        ...
                        if ("string" === n)
                            for (var t, i = 0, o = ee(this), r = e.match(fe) || []; t = r[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
            ...
            ee.fn.extend({
                val: function(e) {
                    ...
                    return arguments.length ? (i = ee.isFunction(e), this.each(function(n) {
                        var o;
                        1 === this.nodeType && (o = i ? e.call(this, n, ee(this).val()) : e, null == o ? o = "" : "number" == typeof o ? o += "" : ee.isArray(o) && (o = ee.map(o, function(e) {
                            return null == e ? "" : e + ""
                        })), t = ee.valHooks[this.type] || ee.valHooks[this.nodeName.toLowerCase()], t && "set" in t && void 0 !== t.set(this, o, "value") || (this.value = o))
                    })) : o ? (t = ee.valHooks[o.type] || ee.valHooks[o.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(lt, "") : null == n ? "" : n)) : void 0
                }
            }), ee.extend({
                valHooks: {
                    select: {
                        get: function(e) {
                            for (var t, n, i = e.options, o = e.selectedIndex, r = "select-one" === e.type || 0 > o, s = r ? null : [], a = r ? o + 1 : i.length, l = 0 > o ? a : r ? o : 0; a > l; l++)
                                if (n = i[l], !(!n.selected && l !== o || (K.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && ee.nodeName(n.parentNode, "optgroup"))) {
                        ...
                        set: function(e, t) {
                            for (var n, i, o = e.options, r = ee.makeArray(t), s = o.length; s--;) i = o[s], (i.selected = ee.inArray(ee(i).val(), r) >= 0) && (n = !0);
            ...
            try {
                ...
                pt = Z.createElement("a"), pt.href = "", pt = pt.href
            }
            dt = wt.exec(pt.toLowerCase()) || [], ee.extend({
                active: 0,
                lastModified: {},
                etag: {},
                ajaxSettings: {
                ...
                ajax: function(e, t) {
                    function n(e, t, n, s) {
                        var l, u, v, y, x, S = t;
                        2 !== w && (w = 2, a && clearTimeout(a), i = void 0, r = s || "", b.readyState = e > 0 ? 4 : 0, l = e >= 200 && 300 > e || 304 === e, n && (y = _(d, b, n)), y = R(d, y, b, l), l ? (d.ifModified && (x = b.getResponseHeader("Last-Modified"), x && (ee.lastModified[o] = x), x = b.getResponseHeader("etag"), x && (ee.etag[o] = x)), 204 === e || "HEAD" === d.type ? S = "nocontent" : 304 === e ? S = "notmodified" : (S = y.state, u = y.data, v = y.error, l = !v)) : (v = S, (e || !S) && (S = "error", 0 > e && (e = 0))), b.status = e, b.statusText = (t || S) + "", l ? h.resolveWith(p, [u, S, b]) : h.rejectWith(p, [b, S, v]), b.statusCode(m), m = void 0, c && f.trigger(l ? "ajaxSuccess" : "ajaxError", [b, d, l ? u : v]), g.fireWith(p, [b, S]), c && (f.trigger("ajaxComplete", [b, d]), --ee.active || ee.event.trigger("ajaxStop")))
                    }
                    "object" == typeof e && (t = e, e = void 0), t = t || {};
                    var i, o, r, s, a, l, c, u, d = ee.ajaxSetup({}, t),
                        p = d.context || d,
                        ...
                        b = {
                            ...
                            getResponseHeader: function(e) {
                                ...
                                if (2 === w) {
                                    if (!s)
                                        for (s = {}; t = gt.exec(r);) s[t[1].toLowerCase()] = t[2];
                                    t = s[e.toLowerCase()]
                                }
                    ...
                    if (h.promise(b).complete = g.add, b.success = b.done, b.error = b.fail, d.url = ((e || d.url || pt) + "").replace(ft, "").replace(yt, dt[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = ee.trim(d.dataType || "*").toLowerCase().match(fe) || [""], null == d.crossDomain && (l = wt.exec(d.url.toLowerCase()), d.crossDomain = !(!l || l[1] === dt[1] && l[2] === dt[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (dt[3] || ("http:" === dt[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = ee.param(d.data, d.traditional)), F(xt, d, t, b), 2 === w) return b;
                    c = d.global, c && 0 === ee.active++ && ee.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !vt.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (ut.test(o) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = ht.test(o) ? o.replace(ht, "$1_=" + ct++) : o + (ut.test(o) ? "&" : "?") + "_=" + ct++)), d.ifModified && (ee.lastModified[o] && b.setRequestHeader("If-Modified-Since", ee.lastModified[o]), ee.etag[o] && b.setRequestHeader("If-None-Match", ee.etag[o])), (d.data && d.hasContent && d.contentType !== !1 || t.contentType) && b.setRequestHeader("Content-Type", d.contentType), b.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + St + "; q=0.01" : "") : d.accepts["*"]);
                    for (u in d.headers) b.setRequestHeader(u, d.headers[u]);
                    if (d.beforeSend && (d.beforeSend.call(p, b, d) === !1 || 2 === w)) return b.abort();
                    x = "abort";
                    for (u in {
                            success: 1,
                            error: 1,
                    ...
                    if (i = F(bt, d, t, b)) {
                        b.readyState = 1, c && f.trigger("ajaxSend", [b, d]), d.async && d.timeout > 0 && (a = setTimeout(function() {
                            b.abort("timeout")
                        }, d.timeout));
                        try {
                            w = 1, i.send(v, n)
                ...
                ee[t] = function(e, n, i, o) {
                    return ee.isFunction(n) && (o = o || i, i = n, n = void 0), ee.ajax({
                        url: e,
                        type: t,
                        dataType: o,
                        data: n,
            ...
            e.ActiveXObject && ee(e).on("unload", function() {
            ...
            }), K.cors = !!jt && "withCredentials" in jt, K.ajax = jt = !!jt, ee.ajaxTransport(function(e) {
                var t;
                return K.cors || jt && !e.crossDomain ? {
                    send: function(n, i) {
                        ...
                        t = function(e) {
                            return function() {
                                t && (delete Pt[s], t = r.onload = r.onerror = null, "abort" === e ? r.abort() : "error" === e ? i(r.status, r.statusText) : i(Dt[r.status] || r.status, r.statusText, "string" == typeof r.responseText ? {
                                    text: r.responseText
                                } : void 0, r.getAllResponseHeaders()))
                            }
                        }, r.onload = t(), r.onerror = t("error"), t = Pt[s] = t("abort"), r.send(e.hasContent && e.data || null)
                    },
                    abort: function() {
                        t && t()
                    }
            ...
            ee.ajaxSetup({
                ...
                return a || "jsonp" === t.dataTypes[0] ? (o = t.jsonpCallback = ee.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Ht, "$1" + o) : t.jsonp !== !1 && (t.url += (ut.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
                    return s || ee.error(o + " was not called"), s[0]
                }, t.dataTypes[0] = "json", r = e[o], e[o] = function() {
                    s = arguments
                }, i.always(function() {
                    e[o] = r, t[o] && (t.jsonpCallback = n.jsonpCallback, Nt.push(o)), s && ee.isFunction(r) && r(s[0]), s = r = void 0
                }), "script") : void 0
                ...
                var i = se.exec(e),
                    o = !n && [];
                return i ? [t.createElement(i[1])] : (i = ee.buildFragment([e], t, o), o && o.length && ee(o).remove(), ee.merge([], i.childNodes))
            };
            var It = ee.fn.load;
            ee.fn.load = function(e, t, n) {
                ...
                var i, o, r, s = this,
                    a = e.indexOf(" ");
                return a >= 0 && (i = e.slice(a), e = e.slice(0, a)), ee.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), s.length > 0 && ee.ajax({
                    url: e,
                    type: o,
                    dataType: "html",
                    data: t
            ...
            ee.offset = {
                setOffset: function(e, t, n) {
                    var i, o, r, s, a, l, c, u = ee.css(e, "position"),
                        d = ee(e),
                        p = {};
                    "static" === u && (e.style.position = "relative"), a = d.offset(), r = ee.css(e, "top"), l = ee.css(e, "left"), c = ("absolute" === u || "fixed" === u) && (r + l).indexOf("auto") > -1, c ? (i = d.position(), s = i.top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), ee.isFunction(t) && (t = t.call(e, n, a)), null != t.top && (p.top = t.top - a.top + s), null != t.left && (p.left = t.left - a.left + o), "using" in t ? t.using.call(e, p) : d.css(p)
                }
            }, ee.fn.extend({
                offset: function(e) {
                    ...
                    var t, n, i = this[0],
                        ...
                        r = i && i.ownerDocument;
                    return r ? (t = r.documentElement, ee.contains(t, i) ? (typeof i.getBoundingClientRect !== ke && (o = i.getBoundingClientRect()), n = B(r), {
                ...
                ee.cssHooks[t] = S(K.pixelPosition, function(e, n) {
                    return n ? (n = b(e, t), qe.test(n) ? ee(e).position()[t] + "px" : n) : void 0
                })
            }), ee.each({
                Height: "height",
                Width: "width"
                ...
                ee.each({
                    ...
                    ee.fn[i] = function(i, o) {
                        ...
                        return me(this, function(t, n, i) {
                            var o;
                            return ee.isWindow(t) ? t.document.documentElement["client" + e] : 9 === t.nodeType ? (o = t.documentElement, Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === i ? ee.css(t, n, s) : ee.style(t, n, i, s)
                        }, t, r ? i : void 0, r, null)
                    }
                })
            }), ee.fn.size = function() {
            ...
            return ee.noConflict = function(t) {
                return e.$ === ee && (e.$ = _t), t && e.jQuery === ee && (e.jQuery = Ot), ee
    ...
    9: [function(e, t, n) {
        ! function(e, t, n, i) {
            ...
            function o(t, n) {
                ...
                e.extend(this, a, n, i), this.calibrationTimer = null, this.calibrationFlag = !0, this.enabled = !1, this.depths = [], this.raf = null, this.bounds = null, this.ex = 0, this.ey = 0, this.ew = 0, this.eh = 0, this.ecx = 0, this.ecy = 0, this.erx = 0, this.ery = 0, this.cx = 0, this.cy = 0, this.ix = 0, this.iy = 0, this.mx = 0, this.my = 0, this.vx = 0, this.vy = 0, this.onMouseMove = this.onMouseMove.bind(this), this.onDeviceOrientation = this.onDeviceOrientation.bind(this), this.onOrientationTimer = this.onOrientationTimer.bind(this), this.onCalibrationTimer = this.onCalibrationTimer.bind(this), this.onAnimationFrame = this.onAnimationFrame.bind(this), this.onWindowResize = this.onWindowResize.bind(this), this.initialise()
            }
            var r = "parallax",
                s = 30,
                a = {
            ...
            o.prototype.transformSupport = function(e) {
                    ...
                    case "3D":
                        if (r) {
                            var p = n.body || n.createElement("body"),
                                f = n.documentElement,
                                h = f.style.overflow;
                            n.body || (f.style.overflow = "hidden", f.appendChild(p), p.style.overflow = "hidden", p.style.background = ""), p.appendChild(o), o.style[c] = "translate3d(1px,1px,1px)", s = t.getComputedStyle(o).getPropertyValue(l), a = s !== i && s.length > 0 && "none" !== s, f.style.overflow = h, p.removeChild(o)
                        }
                }
                return a
                ...
                if (!r)
                    for (var s = 0, a = this.vendors.length; a > s; s++)
                        if (r = null !== this.vendors[s] ? e.camelCase(this.vendors[s][1] + "-" + n) : n, t.style[r] !== i) {
            ...
            e.fn[r] = function(t) {
                ...
                return this.each(function() {
                    var i = e(this),
                        s = i.data(r);
                    s || (s = new o(this, t), i.data(r, s)), l[t] && s[t].apply(s, Array.prototype.slice.call(n, 1))
                })
            }
    ...
    10: [function(e, t, n) {
        ...
        ! function() {
            ...
            function n(e, n) {
                if (this.path = e || "", "undefined" != typeof n && null !== n) this.at_2x_path = n, this.perform_check = !1;
                    ...
                    if (void 0 !== document.createElement) {
                        ...
                        o[0] = o[0].replace(s, t), this.at_2x_path = o.join("?")
                    }
            ...
            o.Retina = e, e.configure = function(e) {
                ...
                e.onload = function() {
                    var e, n, o = document.getElementsByTagName("img"),
                        r = [];
                    for (e = 0; e < o.length; e += 1) n = o[e], n.getAttributeNode("data-no-retina") || r.push(new i(n));
                    t()
                }
            }, e.isRetina = function() {
            ...
            }, o.RetinaImage = i, i.prototype.swap = function(e) {
                function t() {
                    n.el.complete ? (r.force_original_dimensions, n.el.setAttribute("src", e)) : setTimeout(t, 5)
                }
    ...
    11: [function(e, t, n) {
        var i = function(e, t) {
            ...
            function o() {
                var e = j - I;
                return t.freeMode && (e = j - I), t.slidesPerView > A.slides.length && !t.centeredSlides && (e = 0), 0 > e && (e = 0), e
            }
            ...
            function r() {
                function e(e) {
                    ...
                    e.complete ? o() : (i = e.currentSrc || e.getAttribute("src"), i ? (n = new Image, n.onload = o, n.onerror = o, n.src = i) : o())
                }
                var i = A.h.addEventListener,
                    o = "wrapper" === t.eventTarget ? A.wrapper : A.container;
                if (A.browser.ie10 || A.browser.ie11 ? (i(o, A.touchEvents.touchStart, g), i(document, A.touchEvents.touchMove, m), i(document, A.touchEvents.touchEnd, v)) : (A.support.touch && (i(o, "touchstart", g), i(o, "touchmove", m), i(o, "touchend", v)), t.simulateTouch && (i(o, "mousedown", g), i(document, "mousemove", m), i(document, "mouseup", v))), t.autoResize && i(window, "resize", A.resizeFix), s(), A._wheelEvent = !1, t.mousewheelControl) {
                    if (void 0 !== document.onmousewheel && (A._wheelEvent = "mousewheel"), !A._wheelEvent) try {
                        new WheelEvent("wheel"), A._wheelEvent = "wheel"
                    } catch (r) {}
                    A._wheelEvent || (A._wheelEvent = "DOMMouseScroll"), A._wheelEvent && i(A.container, A._wheelEvent, c)
                }
                if (t.keyboardControl && i(document, "keydown", l), t.updateOnImagesReady) {
                    A.imagesToLoad = n("img", A.container);
                    for (var a = 0; a < A.imagesToLoad.length; a++) e(A.imagesToLoad[a])
                }
            }
            ...
            function s() {
                ...
                if (t.onSlideClick)
                    for (e = 0; e < A.slides.length; e++) i(A.slides[e], "click", u);
                if (t.onSlideTouch)
                    for (e = 0; e < A.slides.length; e++) i(A.slides[e], A.touchEvents.touchStart, d)
            }
            ...
            function l(e) {
                ...
                if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey)) {
                    if (37 === t || 39 === t || 38 === t || 40 === t) {
                        for (var n = !1, i = A.h.getOffset(A.container), o = A.h.windowScroll().left, r = A.h.windowScroll().top, s = A.h.windowWidth(), a = A.h.windowHeight(), l = [
                                [i.left, i.top],
                    ...
                    R ? ((37 === t || 39 === t) && (e.preventDefault ? e.preventDefault() : e.returnValue = !1), 39 === t && A.swipeNext(), 37 === t && A.swipePrev()) : ((38 === t || 40 === t) && (e.preventDefault ? e.preventDefault() : e.returnValue = !1), 40 === t && A.swipeNext(), 38 === t && A.swipePrev())
                }
            }
            ...
            function c(e) {
                ...
                } else(new Date).getTime() - $ > 60 && (0 > i ? A.swipeNext() : A.swipePrev()), $ = (new Date).getTime();
            ...
            function g(e) {
                ...
                if (J = !1, A.isTouched = !0, Z = "touchstart" === e.type, !Z && "which" in e && 3 === e.which) return A.isTouched = !1, !1;
                if (!Z || 1 === e.targetTouches.length) {
                    A.callPlugins("onTouchStartBegin"), !Z && !A.isAndroid && i.indexOf(n.tagName.toLowerCase()) < 0 && (e.preventDefault ? e.preventDefault() : e.returnValue = !1);
                    var o = Z ? e.targetTouches[0].pageX : e.pageX || e.clientX,
                        r = Z ? e.targetTouches[0].pageY : e.pageY || e.clientY;
                    A.touches.startX = A.touches.currentX = o, A.touches.startY = A.touches.currentY = r, A.touches.start = A.touches.current = R ? o : r, A.setWrapperTransition(0), A.positions.start = A.positions.current = A.getWrapperTranslate(), A.setWrapperTranslate(A.positions.start), A.times.start = (new Date).getTime(), H = void 0, t.moveStartThreshold > 0 && (U = !1), t.onTouchStart && A.fireCallback(t.onTouchStart, A, e), A.callPlugins("onTouchStartEnd")
                }
            }
            ...
            function m(e) {
                if (A.isTouched && !t.onlyExternal && (!Z || "mousemove" !== e.type)) {
                    ...
                    if ("undefined" == typeof H && R && (H = !!(H || Math.abs(i - A.touches.startY) > Math.abs(n - A.touches.startX))), "undefined" != typeof H || R || (H = !!(H || Math.abs(i - A.touches.startY) < Math.abs(n - A.touches.startX))), H) return void(A.isTouched = !1);
                    if (R) {
                    ...
                    if (e.assignedToSwiper = !0, t.preventLinks && (A.allowLinks = !1), t.onSlideClick && (A.allowSlideClick = !1), t.autoplay && A.stopAutoplay(!0), !Z || 1 === e.touches.length) {
                        if (A.isMoved || (A.callPlugins("onTouchMoveStart"), t.loop && (A.fixLoop(), A.positions.start = A.getWrapperTranslate()), t.onTouchMoveStart && A.fireCallback(t.onTouchMoveStart, A)), A.isMoved = !0, e.preventDefault ? e.preventDefault() : e.returnValue = !1, A.touches.current = R ? n : i, A.positions.current = (A.touches.current - A.touches.start) * t.touchRatio + A.positions.start, A.positions.current > 0 && t.onResistanceBefore && A.fireCallback(t.onResistanceBefore, A, A.positions.current), A.positions.current < -o() && t.onResistanceAfter && A.fireCallback(t.onResistanceAfter, A, Math.abs(A.positions.current + o())), t.resistance && "100%" !== t.resistance) {
                            var r;
                            if (A.positions.current > 0 && (r = 1 - A.positions.current / I / 2, .5 > r ? A.positions.current = I / 2 : A.positions.current = A.positions.current * r), A.positions.current < -o()) {
                        ...
                        if (t.moveStartThreshold)
                            if (Math.abs(A.touches.current - A.touches.start) > t.moveStartThreshold || U) {
                                if (!U) return U = !0, void(A.touches.start = A.touches.current);
            ...
            function v(e) {
                if (H && A.swipeReset(), !t.onlyExternal && A.isTouched) {
                    ...
                    5 > i && 300 > r && A.allowLinks === !1 && (t.freeMode || 0 === i || A.swipeReset(), t.preventLinks && (A.allowLinks = !0), t.onSlideClick && (A.allowSlideClick = !0)), setTimeout(function() {
                    ...
                    if (A.isMoved = !1, t.freeMode) {
                        if (t.freeModeFluid) {
                            var a, l = 1e3 * t.momentumRatio,
                                c = A.velocity * l,
                                u = A.positions.current + c,
                                d = !1,
                                p = 20 * Math.abs(A.velocity) * t.momentumBounceRatio; - s > u && (t.momentumBounce && A.support.transitions ? (-p > u + s && (u = -s - p), a = -s, d = !0, J = !0) : u = -s), u > 0 && (t.momentumBounce && A.support.transitions ? (u > p && (u = p), a = 0, d = !0, J = !0) : u = 0), 0 !== A.velocity && (l = Math.abs((u - A.positions.current) / A.velocity)), A.setWrapperTranslate(u), A.setWrapperTransition(l), t.momentumBounce && d && A.wrapperTransitionEnd(function() {
                                J && (t.onMomentumBounce && A.fireCallback(t.onMomentumBounce, A), A.callPlugins("onMomentumBounce"), A.setWrapperTranslate(a), A.setWrapperTransition(300))
                    ...
                    N = 0 > n ? "toNext" : "toPrev", "toNext" === N && 300 >= r && (30 > i || !t.shortSwipes ? A.swipeReset() : A.swipeNext(!0, !0)), "toPrev" === N && 300 >= r && (30 > i || !t.shortSwipes ? A.swipeReset() : A.swipePrev(!0, !0));
                    var f = 0;
                    if ("auto" === t.slidesPerView) {
                        for (var h, g = Math.abs(A.getWrapperTranslate()), m = 0, v = 0; v < A.slides.length; v++)
                            if (h = R ? A.slides[v].getWidth(!0, t.roundLengths) : A.slides[v].getHeight(!0, t.roundLengths), m += h, m > g) {
                                f = h;
                                break
                            }
                        f > I && (f = I)
                    } else f = D * t.slidesPerView;
                    "toNext" === N && r > 300 && (i >= f * t.longSwipesRatio ? A.swipeNext(!0, !0) : A.swipeReset()), "toPrev" === N && r > 300 && (i >= f * t.longSwipesRatio ? A.swipePrev(!0, !0) : A.swipeReset()), t.onTouchEnd && A.fireCallback(t.onTouchEnd, A, e), A.callPlugins("onTouchEnd")
                }
            }
            ...
            function b(e, n, i) {
                function o() {
                    var r = +new Date,
                        d = r - s;
                    a += l * d / (1e3 / 60), u = "toNext" === c ? a > e : e > a, u ? (A.setWrapperTranslate(Math.ceil(a)), A._DOMAnimating = !0, window.setTimeout(function() {
                        o()
                    }, 1e3 / 60)) : (t.onSlideChangeEnd && ("to" === n ? i.runCallbacks === !0 && A.fireCallback(t.onSlideChangeEnd, A, c) : A.fireCallback(t.onSlideChangeEnd, A, c)), A.setWrapperTranslate(e), A._DOMAnimating = !1)
                }
                var r = "to" === n && i.speed >= 0 ? i.speed : t.speed,
                    s = +new Date;
                if (A.support.transitions || !t.DOMAnimation) A.setWrapperTranslate(e), A.setWrapperTransition(r);
                else {
                ...
                A.updateActiveSlide(e), t.onSlideNext && "next" === n && i.runCallbacks === !0 && A.fireCallback(t.onSlideNext, A, e), t.onSlidePrev && "prev" === n && i.runCallbacks === !0 && A.fireCallback(t.onSlidePrev, A, e), t.onSlideReset && "reset" === n && i.runCallbacks === !0 && A.fireCallback(t.onSlideReset, A, e), "next" !== n && "prev" !== n && "to" !== n || i.runCallbacks !== !0 || S(n)
            }
            ...
            function T() {
                ...
                if (e)
                    for (var t = 0; t < e.length; t++) A.h.removeEventListener(e[t], "click", k)
            }

            function C() {
                var e = A.paginationButtons;
                if (e)
                    for (var t = 0; t < e.length; t++) A.h.addEventListener(e[t], "click", k)
            }

            function k(e) {
                for (var n, i = e.target || e.srcElement, o = A.paginationButtons, r = 0; r < o.length; r++) i === o[r] && (n = r);
            ...
            if (window.getComputedStyle || (window.getComputedStyle = function(e, t) {
                ...
                }, A.id = (new Date).getTime(), A.container = e.nodeType ? e : n(e)[0], A.isTouched = !1, A.isMoved = !1, A.activeIndex = 0, A.centerIndex = 0, A.activeLoaderIndex = 0, A.activeLoopIndex = 0, A.previousIndex = null, A.velocity = 0, A.snapGrid = [], A.slidesGrid = [], A.imagesToLoad = [], A.imagesLoaded = 0, A.wrapperLeft = 0, A.wrapperRight = 0, A.wrapperTop = 0, A.wrapperBottom = 0, A.isAndroid = navigator.userAgent.toLowerCase().indexOf("android") >= 0;
                var P, D, j, N, H, I, F = {
                    eventTarget: "wrapper",
                    mode: "horizontal",
                    touchRatio: 1,
                ...
                for (var O in F)
                    if (O in t && "object" == typeof t[O])
                        for (var _ in F[O]) _ in t[O] || (t[O][_] = F[O][_]);
                    else O in t || (t[O] = F[O]);
                ...
                A.browser.ie10 && (W = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), A.browser.ie11 && (W = ["pointerdown", "pointermove", "pointerup"]), A.touchEvents = {
                ...
                for (var B = A.container.childNodes.length - 1; B >= 0; B--)
                    if (A.container.childNodes[B].className)
                        for (var q = A.container.childNodes[B].className.split(/\s+/), z = 0; z < q.length; z++) q[z] === t.wrapperClass && (P = A.container.childNodes[B]);
                A.wrapper = P, A._extendSwiperSlide = function(e) {
                    ...
                    for (var i = 0; i < A.wrapper.childNodes.length; i++)
                        if (A.wrapper.childNodes[i].className)
                            for (var o = A.wrapper.childNodes[i].className, r = o.split(/\s+/), l = 0; l < r.length; l++) r[l] === t.slideClass && A.slides.push(A.wrapper.childNodes[i]);
                    for (i = A.slides.length - 1; i >= 0; i--) A._extendSwiperSlide(A.slides[i]);
                    n !== !1 && (n !== A.slides.length || e) && (a(), s(), A.updateActiveSlide(), A.params.pagination && A.createPagination(), A.callPlugins("numberOfSlidesChanged"))
                }, A.createSlide = function(e, n, i) {
                    n = n || A.params.slideClass, i = i || t.slideElement;
                    var o = document.createElement(i);
                    return o.innerHTML = e || "", o.className = n, A._extendSwiperSlide(o)
                    ...
                    var n, o = this;
                    return o.params["on" + e] ? i(this.params["on" + e]) ? this.params["on" + e].push(t) : "function" == typeof this.params["on" + e] ? (n = this.params["on" + e], this.params["on" + e] = [], this.params["on" + e].push(n), this.params["on" + e].push(t)) : void 0 : (this.params["on" + e] = [], this.params["on" + e].push(t))
                ...
                A.callPlugins = function(e, t) {
                    t || (t = {});
                    for (var n = 0; n < X.length; n++) e in X[n] && X[n][e](t)
                }, !A.browser.ie10 && !A.browser.ie11 || t.onlyExternal || A.wrapper.classList.add("swiper-wp8-" + (R ? "horizontal" : "vertical")), t.freeMode && (A.container.className += " swiper-free-mode"), A.initialized = !1, A.init = function(e, n) {
                    ...
                    if (i !== A.width || o !== A.height || e) {
                        ...
                        if (e && A.calcSlides(n), "auto" === t.slidesPerView) {
                            var f = 0,
                                h = 0;
                            t.slidesOffset > 0 && (p.style.paddingLeft = "", p.style.paddingRight = "", p.style.paddingTop = "", p.style.paddingBottom = ""), p.style.width = "", p.style.height = "", t.offsetPxBefore > 0 && (R ? A.wrapperLeft = t.offsetPxBefore : A.wrapperTop = t.offsetPxBefore), t.offsetPxAfter > 0 && (R ? A.wrapperRight = t.offsetPxAfter : A.wrapperBottom = t.offsetPxAfter), t.centeredSlides && (R ? (A.wrapperLeft = (I - this.slides[0].getWidth(!0, t.roundLengths)) / 2, A.wrapperRight = (I - A.slides[A.slides.length - 1].getWidth(!0, t.roundLengths)) / 2) : (A.wrapperTop = (I - A.slides[0].getHeight(!0, t.roundLengths)) / 2, A.wrapperBottom = (I - A.slides[A.slides.length - 1].getHeight(!0, t.roundLengths)) / 2)), R ? (A.wrapperLeft >= 0 && (p.style.paddingLeft = A.wrapperLeft + "px"), A.wrapperRight >= 0 && (p.style.paddingRight = A.wrapperRight + "px")) : (A.wrapperTop >= 0 && (p.style.paddingTop = A.wrapperTop + "px"), A.wrapperBottom >= 0 && (p.style.paddingBottom = A.wrapperBottom + "px")), u = 0;
                            var g = 0;
                            for (A.snapGrid = [], A.slidesGrid = [], a = 0, d = 0; d < A.slides.length; d++) {
                                r = A.slides[d].getWidth(!0, t.roundLengths), s = A.slides[d].getHeight(!0, t.roundLengths), t.calculateHeight && (a = Math.max(a, s));
                                var m = R ? r : s;
                                if (t.centeredSlides) {
                                    var v = d === A.slides.length - 1 ? 0 : A.slides[d + 1].getWidth(!0, t.roundLengths),
                                        ...
                                        w = R ? v : y;
                                    if (m > I) {
                                        if (t.slidesPerViewFit) A.snapGrid.push(u + A.wrapperLeft), A.snapGrid.push(u + m - I + A.wrapperLeft);
                                        else
                                            for (var x = 0; x <= Math.floor(m / (I + A.wrapperLeft)); x++) 0 === x ? A.snapGrid.push(u + A.wrapperLeft) : A.snapGrid.push(u + A.wrapperLeft + I * x);
                                        A.slidesGrid.push(u + A.wrapperLeft)
                                    } else A.snapGrid.push(g), A.slidesGrid.push(g);
                                    g += m / 2 + w / 2
                                } else {
                                    if (m > I)
                                        if (t.slidesPerViewFit) A.snapGrid.push(u), A.snapGrid.push(u + m - I);
                                        else if (0 !== I)
                                        for (var b = 0; b <= Math.floor(m / I); b++) A.snapGrid.push(u + I * b);
                                    else A.snapGrid.push(u);
                                    else A.snapGrid.push(u);
                                    A.slidesGrid.push(u)
                                }
                                u += m, f += r, h += s
                            }
                            t.calculateHeight && (A.height = a), R ? (j = f + A.wrapperRight + A.wrapperLeft, t.cssWidthAndHeight && "height" !== t.cssWidthAndHeight || (p.style.width = f + "px"), t.cssWidthAndHeight && "width" !== t.cssWidthAndHeight || (p.style.height = A.height + "px")) : (t.cssWidthAndHeight && "height" !== t.cssWidthAndHeight || (p.style.width = A.width + "px"), t.cssWidthAndHeight && "width" !== t.cssWidthAndHeight || (p.style.height = h + "px"), j = h + A.wrapperTop + A.wrapperBottom)
                        } else if (t.scrollContainer) p.style.width = "", p.style.height = "", l = A.slides[0].getWidth(!0, t.roundLengths), c = A.slides[0].getHeight(!0, t.roundLengths), j = R ? l : c, p.style.width = l + "px", p.style.height = c + "px", D = R ? l : c;
                        else {
                            if (t.calculateHeight) {
                                for (a = 0, c = 0, R || (A.container.style.height = ""), p.style.height = "", d = 0; d < A.slides.length; d++) A.slides[d].style.height = "", a = Math.max(A.slides[d].getHeight(!0), a), R || (c += A.slides[d].getHeight(!0));
                                s = a, A.height = s, R ? c = s : (I = s, A.container.style.height = I + "px")
                            } else s = R ? A.height : A.height / t.slidesPerView, t.roundLengths && (s = Math.ceil(s)), c = R ? A.height : A.slides.length * s;
                            for (r = R ? A.width / t.slidesPerView : A.width, t.roundLengths && (r = Math.ceil(r)), l = R ? A.slides.length * r : A.width, D = R ? r : s, t.offsetSlidesBefore > 0 && (R ? A.wrapperLeft = D * t.offsetSlidesBefore : A.wrapperTop = D * t.offsetSlidesBefore), t.offsetSlidesAfter > 0 && (R ? A.wrapperRight = D * t.offsetSlidesAfter : A.wrapperBottom = D * t.offsetSlidesAfter), t.offsetPxBefore > 0 && (R ? A.wrapperLeft = t.offsetPxBefore : A.wrapperTop = t.offsetPxBefore), t.offsetPxAfter > 0 && (R ? A.wrapperRight = t.offsetPxAfter : A.wrapperBottom = t.offsetPxAfter), t.centeredSlides && (R ? (A.wrapperLeft = (I - D) / 2, A.wrapperRight = (I - D) / 2) : (A.wrapperTop = (I - D) / 2, A.wrapperBottom = (I - D) / 2)), R ? (A.wrapperLeft > 0 && (p.style.paddingLeft = A.wrapperLeft + "px"), A.wrapperRight > 0 && (p.style.paddingRight = A.wrapperRight + "px")) : (A.wrapperTop > 0 && (p.style.paddingTop = A.wrapperTop + "px"), A.wrapperBottom > 0 && (p.style.paddingBottom = A.wrapperBottom + "px")), j = R ? l + A.wrapperRight + A.wrapperLeft : c + A.wrapperTop + A.wrapperBottom, parseFloat(l) > 0 && (!t.cssWidthAndHeight || "height" === t.cssWidthAndHeight) && (p.style.width = l + "px"), parseFloat(c) > 0 && (!t.cssWidthAndHeight || "width" === t.cssWidthAndHeight) && (p.style.height = c + "px"), u = 0, A.snapGrid = [], A.slidesGrid = [], d = 0; d < A.slides.length; d++) A.snapGrid.push(u), A.slidesGrid.push(u), u += D, parseFloat(r) > 0 && (!t.cssWidthAndHeight || "height" === t.cssWidthAndHeight) && (A.slides[d].style.width = r + "px"), parseFloat(s) > 0 && (!t.cssWidthAndHeight || "width" === t.cssWidthAndHeight) && (A.slides[d].style.height = s + "px")
                        }
                    ...
                    if (A.browser.ie10 || A.browser.ie11 ? (n(i, A.touchEvents.touchStart, g), n(document, A.touchEvents.touchMove, m), n(document, A.touchEvents.touchEnd, v)) : (A.support.touch && (n(i, "touchstart", g), n(i, "touchmove", m), n(i, "touchend", v)), t.simulateTouch && (n(i, "mousedown", g), n(document, "mousemove", m), n(document, "mouseup", v))), t.autoResize && n(window, "resize", A.resizeFix), a(), t.paginationClickable && T(), t.mousewheelControl && A._wheelEvent && n(A.container, A._wheelEvent, c), t.keyboardControl && n(document, "keydown", l), t.autoplay && A.stopAutoplay(), e) {
                        A.wrapper.removeAttribute("style");
                        for (var o = 0; o < A.slides.length; o++) A.slides[o].removeAttribute("style")
                    }
                ...
                if (A.disableMousewheelControl = function() {
                        return A._wheelEvent ? (t.mousewheelControl = !1, A.h.removeEventListener(A.container, A._wheelEvent, c), !0) : !1
                    }, A.enableMousewheelControl = function() {
                        return A._wheelEvent ? (t.mousewheelControl = !0, A.h.addEventListener(A.container, A._wheelEvent, c), !0) : !1
                    }, t.grabCursor) {
                ...
                A.swipeNext = function(e, n) {
                    "undefined" == typeof e && (e = !0), !n && t.loop && A.fixLoop(), !n && t.autoplay && A.stopAutoplay(!0),
                    ...
                    return i > 0 && (i = 0), i === o ? !1 : (b(i, "prev", {
                        runCallbacks: e
                    }), !0)
                }, A.swipeReset = function(e) {
                    "undefined" == typeof e && (e = !0), A.callPlugins("onSwipeReset");
                    var n, i = A.getWrapperTranslate(),
                        r = D * t.slidesPerGroup; - o();
                    if ("auto" === t.slidesPerView) {
                        n = 0;
                        for (var s = 0; s < A.snapGrid.length; s++) {
                            if (-i === A.snapGrid[s]) return;
                            if (-i >= A.snapGrid[s] && -i < A.snapGrid[s + 1]) {
                                n = A.positions.diff > 0 ? -A.snapGrid[s + 1] : -A.snapGrid[s];
                                break
                            }
                        } - i >= A.snapGrid[A.snapGrid.length - 1] && (n = -A.snapGrid[A.snapGrid.length - 1]), i <= -o() && (n = -o())
                    } else n = 0 > i ? Math.round(i / r) * r : 0, i <= -o() && (n = -o());
                    return t.scrollContainer && (n = 0 > i ? i : 0), n < -o() && (n = -o()), t.scrollContainer && I > D && (n = 0), n === i ? !1 : (b(n, "reset", {
                        runCallbacks: e
                    }), !0)
                    ...
                    if (!(e > A.slides.length - 1 || 0 > e)) {
                        var s;
                        return s = "auto" === t.slidesPerView ? -A.slidesGrid[e] : -e * D, s < -o() && (s = -o()), s === r ? !1 : ("undefined" == typeof i && (i = !0), b(s, "to", {
                            index: e,
                            speed: n,
                            runCallbacks: i
                        }), !0)
                    ...
                    if (A.initialized && 0 !== A.slides.length) {
                        ...
                        } else A.activeIndex = Math[t.visibilityFullFit ? "ceil" : "round"](-e / D);
                        if (A.activeIndex === A.slides.length && (A.activeIndex = A.slides.length - 1), A.activeIndex < 0 && (A.activeIndex = 0), A.slides[A.activeIndex]) {
                            if (A.calcVisibleSlides(e), A.support.classList) {
                                var r;
                                for (n = 0; n < A.slides.length; n++) r = A.slides[n], r.classList.remove(t.slideActiveClass), A.visibleSlides.indexOf(r) >= 0 ? r.classList.add(t.slideVisibleClass) : r.classList.remove(t.slideVisibleClass);
                                ...
                                for (n = 0; n < A.slides.length; n++) A.slides[n].className = A.slides[n].className.replace(s, "").replace(a, ""), A.visibleSlides.indexOf(A.slides[n]) >= 0 && (A.slides[n].className += " " + t.slideVisibleClass);
                    ...
                    if (t.paginationClickable && A.paginationButtons && T(), A.paginationContainer = t.pagination.nodeType ? t.pagination : n(t.pagination)[0], t.createPagination) {
                        var i = "",
                            o = A.slides.length,
                            r = o;
                        t.loop && (r -= 2 * A.loopedSlides);
                        for (var s = 0; r > s; s++) i += "<" + t.paginationElement + ' class="' + t.paginationElementClass + '"></' + t.paginationElement + ">";
                        A.paginationContainer.innerHTML = i
                    }
                    A.paginationButtons = n("." + t.paginationElementClass, A.paginationContainer), e || A.updatePagination(), A.callPlugins("onCreatePagination"), t.paginationClickable && C()
                            ...
                            if (0 !== o.length) {
                                ...
                                if (t.paginationAsRange) {
                                    ...
                                    for (a = 0; a < A.visibleSlides.length; a++) {
                                        ...
                                        t.loop && 0 > c && (c = A.slides.length - 2 * A.loopedSlides + c), t.loop && c >= A.slides.length - 2 * A.loopedSlides && (c = A.slides.length - 2 * A.loopedSlides - c, c = Math.abs(c)), l.push(c)
                                    }
                                ...
                                } else t.loop ? o[A.activeLoopIndex] && (o[A.activeLoopIndex].className += " " + t.paginationActiveClass + " " + t.paginationVisibleClass) : o[A.activeIndex] && (o[A.activeIndex].className += " " + t.paginationActiveClass + " " + t.paginationVisibleClass)
                            }
                        }
                    }
                    ...
                    var n = [],
                        ...
                        o = 0,
                        r = 0;
                    R && A.wrapperLeft > 0 && (e += A.wrapperLeft), !R && A.wrapperTop > 0 && (e += A.wrapperTop);
                    for (var s = 0; s < A.slides.length; s++) {
                        i += o, o = "auto" === t.slidesPerView ? R ? A.h.getWidth(A.slides[s], !0, t.roundLengths) : A.h.getHeight(A.slides[s], !0, t.roundLengths) : D, r = i + o;
                        var a = !1;
                        t.visibilityFullFit ? (i >= -e && -e + I >= r && (a = !0), -e >= i && r >= -e + I && (a = !0)) : (r > -e && -e + I >= r && (a = !0), i >= -e && -e + I > i && (a = !0), -e > i && r > -e + I && (a = !0)), a && n.push(A.slides[s])
                    }
                ...
                A.startAutoplay = function() {
                    if (A.support.transitions) {
                        ...
                        A.callPlugins("onAutoplayStart"), t.onAutoplayStart && A.fireCallback(t.onAutoplayStart, A), E()
                    } else {
                    ...
                    if (0 !== A.slides.length) {
                        "auto" === t.slidesPerView ? A.loopedSlides = t.loopedSlides || 1 : A.loopedSlides = Math.floor(t.slidesPerView) + t.loopAdditionalSlides, A.loopedSlides > A.slides.length && (A.loopedSlides = A.slides.length);
                        var e, n = "",
                            i = "",
                            o = "",
                            r = A.slides.length,
                            s = Math.floor(A.loopedSlides / r),
                            a = A.loopedSlides % r;
                        for (e = 0; s * r > e; e++) {
                            var l = e;
                            if (e >= r) {
                        ...
                        for (e = 0; a > e; e++) i += x(t.slideDuplicateClass, A.slides[e].outerHTML);
                        for (e = r - a; r > e; e++) n += x(t.slideDuplicateClass, A.slides[e].outerHTML);
                        var u = n + o + P.innerHTML + o + i;
                        for (P.innerHTML = u, A.loopCreated = !0, A.calcSlides(), e = 0; e < A.slides.length; e++)(e < A.loopedSlides || e >= A.slides.length - A.loopedSlides) && A.slides[e].setData("looped", !0);
                    ...
                    for (var n = t.loader.slides, i = t.loader.loadAllSlides ? n.length : t.slidesPerView * (1 + t.loader.surroundGroups), o = 0; i > o; o++) e += "outer" === t.loader.slidesHTMLType ? n[o] : "<" + t.slideElement + ' class="' + t.slideClass + '" data-swiperindex="' + o + '">' + n[o] + "</" + t.slideElement + ">";
                    ...
                    if (!(0 > n || n > e.length - 1)) {
                        ...
                        if ("reload" === t.loader.logic) {
                            A.wrapper.innerHTML = "";
                            var a = "";
                            for (s = i; o >= s; s++) a += "outer" === t.loader.slidesHTMLType ? e[s] : "<" + t.slideElement + ' class="' + t.slideClass + '" data-swiperindex="' + s + '">' + e[s] + "</" + t.slideElement + ">";
        ...
        i.prototype = {
            ...
            h: {
                getWidth: function(e, t, n) {
                    ...
                    var i = window.getComputedStyle(e, null).getPropertyValue("width"),
                        o = parseFloat(i);
                    return (isNaN(o) || i.indexOf("%") > 0 || 0 > o) && (o = e.offsetWidth - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-left")) - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-right"))), t && (o += parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-left")) + parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-right"))), n ? Math.ceil(o) : o
                },
                getHeight: function(e, t, n) {
                    ...
                    var i = window.getComputedStyle(e, null).getPropertyValue("height"),
                        o = parseFloat(i);
                    return (isNaN(o) || i.indexOf("%") > 0 || 0 > o) && (o = e.offsetHeight - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-top")) - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-bottom"))), t && (o += parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-top")) + parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-bottom"))), n ? Math.ceil(o) : o
                },
            ...
            setTranslate: function(e, t) {
                ...
                n.webkitTransform = n.MsTransform = n.msTransform = n.MozTransform = n.OTransform = n.transform = o, this.support.transforms || (n.left = i.x + "px", n.top = i.y + "px")
            },
